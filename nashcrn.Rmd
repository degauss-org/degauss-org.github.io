...
```{r}
read_csv(
  'example_data/my_address_file_short_geocoder_3.2.0_score_threshold_0.5.csv'
) %>%
  kable() %>%
  kable_styling(full_width = FALSE, bootstrap_options = "striped") %>%
  column_spec(
...
```{r}
read_csv(
  "example_data/my_address_file_short_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1.csv"
) %>%
  kable() %>%
  kable_styling(full_width = FALSE, bootstrap_options = "striped") %>%
...
```{r}
read_csv(
  "example_data/my_address_file_short_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1_aadt_0.2.0_400m_buffer.csv"
) %>%
  select(-.row) %>%
  kable() %>%
  kable_styling(full_width = FALSE, bootstrap_options = "striped") %>%
...
```{r}
read_csv(
  "example_data/my_address_file_short_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1_aadt_0.2.0_400m_buffer_roads_0.2.1_400m_buffer.csv"
) %>%
  kable() %>%
  kable_styling(full_width = FALSE, bootstrap_options = "striped") %>%
...
```{r}
read_csv(
  "example_data/my_address_file_short_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1_aadt_0.2.0_400m_buffer_roads_0.2.1_400m_buffer_greenspace_0.3.0.csv"
) %>%
  kable() %>%
  kable_styling(full_width = FALSE, bootstrap_options = "striped") %>%
...
```{r}
read_csv(
  "example_data/my_address_file_short_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1_aadt_0.2.0_400m_buffer_roads_0.2.1_400m_buffer_greenspace_0.3.0_drivetime_1.1.0_cchmc.csv"
) %>%
  kable() %>%
  kable_styling(full_width = FALSE, bootstrap_options = "striped") %>%
...
```
docker run --rm -v "$PWD":/tmp ghcr.io/degauss-org/nlcd:1.0.1 my_address_file_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1_aadt_0.2.0_400m_buffer_roads_0.2.1_400m_buffer_greenspace_0.3.0_drivetime_1.1.0_cchmc.csv
```
...
The **output file** is written to the same directory and in our example, will be called `my_address_file_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1_aadt_0.2.0_400m_buffer_roads_0.2.1_400m_buffer_greenspace_0.3.0_drivetime_1.1.0_cchmc_nlcd_1.0.1_400m_buffer.csv`.

Example output:

```{r, eval = F}
read_csv(
  "example_data/my_address_file_short_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1_aadt_0.2.0_400m_buffer_roads_0.2.1_400m_buffer_greenspace_0.3.0_drivetime_1.1.0_cchmc_nlcd_1.0.1_400m_buffer.csv"
) %>%
  kable() %>%
  kable_styling(full_width = FALSE, bootstrap_options = "striped") %>%
...
```
docker run --rm -v "$PWD":/tmp ghcr.io/degauss-org/census_merger:0.1.2 my_address_file_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1_aadt_0.2.0_400m_buffer_roads_0.2.1_400m_buffer_greenspace_0.3.0_drivetime_1.1.0_cchmc_nlcd_1.0.1_400m_buffer.csv nash_crn_census_data_2010.csv
```
Replace `my_address_file_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1_aadt_0.2.0_400m_buffer_roads_0.2.1_400m_buffer_greenspace_0.3.0_drivetime_1.1.0_cchmc_nlcd_1.0.1_400m_buffer.csv` with the name of the CSV file created in Step 9 and run.

The **output file** is written to the same directory and in our example, will be called `my_address_file_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1_aadt_0.2.0_400m_buffer_roads_0.2.1_400m_buffer_greenspace_0.3.0_drivetime_1.1.0_cchmc_nlcd_1.0.1_400m_buffer_nash_crn_census_data_2010_census_merger_0.1.2.csv`.
...
docker run --rm -v "$PWD":/tmp ghcr.io/degauss-org/census_merger:0.1.0 my_address_file_geocoder_3.2.0_score_threshold_0.5_dep_index_0.2.1_aadt_0.2.0_400m_buffer_roads_0.2.1_400m_buffer_greenspace_0.3.0_drivetime_1.1.0_cchmc_nlcd_1.0.1_400m_buffer.csv nash_crn_census_data_2010.csv
```
