...
3. Navigate to the working directory where your address file is located. For example, if your file is saved to the Desktop, use `cd Desktop`. See [here](https://www.digitalocean.com/community/tutorials/basic-linux-navigation-and-file-management) for more information on file navigation. 
