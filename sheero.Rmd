...
```
docker run --rm -v "$PWD":/tmp ghcr.io/degauss-org/census_block_group:0.5.0 my_address_file_geocoded_3.2.0.csv 2010
```
...
The **output file** is written to the same directory and, in our example, will be called `my_address_file_geocoded_3.2.0_census_block_group_0.5.0_2010.csv`.
...
```
docker run --rm -v "$PWD":/tmp ghcr.io/degauss-org/aadt:0.1.1 my_address_file_geocoded_3.2.0_census_block_group_0.5.0_2010.csv 
```

Replace `my_address_file_geocoded_3.2.0_census_block_group_0.5.0_2010.csv ` with the name of the CSV file created in Step 4 and run.

The **output file** is written to the same directory and in our example, will be called `my_address_file_geocoded_3.2.0_census_block_group_0.5.0_2010_aadt_v0.1.1_400m_buffer.csv`.
...
```
docker run --rm -v "$PWD":/tmp ghcr.io/degauss-org/roads:0.2.0 my_address_file_geocoded_3.2.0_census_block_group_0.5.0_2010_aadt_v0.1.1_400m_buffer.csv
```

Replace `my_address_file_geocoded_3.2.0_census_block_group_0.5.0_2010_aadt_v0.1.1_400m_buffer.csv` with the name of the CSV file created in Step 5 and run.

The **output file** is written to the same directory and in our example, will be called `my_address_file_geocoded_3.2.0_census_block_group_0.5.0_2010_aadt_v0.1.1_400m_buffer_roads_0.2.0_400m_buffer.csv`.
...
```
docker run --rm -v "$PWD":/tmp ghcr.io/degauss-org/greenspace:0.2 my_address_file_geocoded_3.2.0_census_block_group_0.5.0_2010_aadt_v0.1.1_400m_buffer_roads_0.2.0_400m_buffer.csv
```

Replace `my_address_file_geocoded_3.2.0_census_block_group_0.5.0_2010_aadt_v0.1.1_400m_buffer_roads_0.2.0_400m_buffer.csv` with the name of the CSV file created in Step 6 and run.

The **output file** is written to the same directory and in our example, will be called `my_address_file_geocoded_3.2.0_census_block_group_0.5.0_2010_aadt_v0.1.1_400m_buffer_roads_0.2.0_400m_buffer_greenspace.csv`.
